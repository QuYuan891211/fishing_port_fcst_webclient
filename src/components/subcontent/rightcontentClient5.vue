...
<!-- <div>自定义查询</div> -->
    ...
    <!-- <v-md-date-range-picker></v-md-date-range-picker> -->
        ...
        <div class="attend" style="padding-left: 10px;">
            <div ref="EchartsClient5" class="line-chart" id="lineChartClient_30" style="width: 950px;height:180px;margin-left:2%"></div>
        </div>
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        ...
        exportpic(){
                ...
                var myChart = echarts.init(this.$refs.EchartsClient5);
